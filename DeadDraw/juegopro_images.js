...
// estas variables cargan las imagenes de los palos
...
class Game{
    ...
    initObjects(){
        // esta funcion crea las cartas con palos al azar
        const tipos = ['corazon', 'picas'];
        for (let i = 0; i < 8; i++){
            let tipo = tipos[Math.floor(Math.random() * tipos.length)];
            let card = new cards(0, 200, 112.5, 150, 1, tipo, 1, false, false, true);
